    ...
    <section id="content">
        ...
        <main>
            ...
            <ul class="breadcrumbs">
                ...
                <li class="divider">/</li>
                <li><a href="" class="active">Add Data Departemen</a></li>
            </ul>
            <div class="container-form">
                <div class="form-card">
                    <h2 class="form-title">Tambah Departemen</h2>
                    ...
                    <form action="{{ route('departemen.store') }}" method="POST">
                        ...
                        <div class="form-actions">
                            ...
                            <a href="{{ route('departemen.dashboard') }}" class="btn btn-secondary">Batal</a>
                        </div>
                    </form>
                </div>
            </div>
