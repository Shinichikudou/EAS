document.addEventListener("DOMContentLoaded", function () {
    ...
    const areaChartOptions = {
        series: [
            {
                name: "Kunjungan",
                data: typeof visitChartData !== 'undefined' ? visitChartData : []
            }
        ],
        chart: {
            height: 350,
        ...
        xaxis: {
            type: 'category',
            categories: typeof visitChartLabels !== 'undefined' ? visitChartLabels : []
        },
        tooltip: {
            x: {
                format: "HH:mm"
    ...
    new ApexCharts(document.querySelector("#chart"), areaChartOptions).render();

    const pieChartOptions = {
        series: typeof deptData !== "undefined" ? deptData : [0],
        chart: { type: "donut", height: 350 },
        labels: typeof deptLabels !== "undefined" ? deptLabels : ["Data Kosong"],
        responsive: [{
            breakpoint: 480,
            options: {
                chart: { width: 200 },
    ...
    new ApexCharts(document.querySelector("#charts"), pieChartOptions).render();
});
